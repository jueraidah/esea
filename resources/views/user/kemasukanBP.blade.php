...
@section('content')
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <h4 style="text-align: center;">e-BORANG PERMOHONAN (PEMEGANG BUKAN PASPORT)</h4>
                <p class="text-wrap">
                    Arahan
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered" id="documentsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td>Salinan Dokumen Pengenalan Diri</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Tiket Feri (Bergantung kepada mod kemasukan ke sabah)</td>
                                        <td>
                                            <input type="file" name="documents[]" class="form-control-file">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>5</td>
                                        <td>Salinan Surat Kemudahan Berlepas yang dikeluarkan oleh JIM Sabah</td>
                                        <td>
                                            <input type="file" name="documents[]" class="form-control-file">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td>Salinan Sijil Nikah (Bagi yang berkahwin dengan warga sabah)</td>
                                        <td>
                                            <input type="file" name="documents[]" class="form-control-file">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>Lain-lain Dokumen Sokongan</td>
                                        <td>
                                            <input type="file" name="documents[]" class="form-control-file">
                                        </td>
                                        <td>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="lokasi"><i>(k)</i>Lokasi Berepas </label>
